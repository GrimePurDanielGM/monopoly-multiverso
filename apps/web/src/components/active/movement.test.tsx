...
describe('MovementPanel', () => {
  ...
  const physSnap = (over: Partial<ActiveSnapshot> = {}) =>
    snap({ game: { code: 'ABC234', status: 'active', config: { initial_money: 3000, min_players: 2, max_players: 16, allow_late_join: false, start_bonus: 200, dice_mode: 'physical_allowed', initial_houses_available: 32, initial_hotels_available: 12, allow_build_without_monopoly: false, allow_trade_built_properties: false } }, ...over });
...
describe('MovementPanel — dados físicos y servicios', () => {
  ...
  const withDice = (dice_mode: 'virtual_only' | 'physical_allowed' | 'physical_only', over: Partial<ActiveSnapshot> = {}) =>
    snap({ game: { code: 'ABC234', status: 'active', config: { initial_money: 3000, min_players: 2, max_players: 16, allow_late_join: false, start_bonus: 200, dice_mode, initial_houses_available: 32, initial_hotels_available: 12, allow_build_without_monopoly: false, allow_trade_built_properties: false } }, ...over });
