  ...
  it('renderiza la pantalla de partida activa en estado active', async () => {
    ...
    activeMock.mockResolvedValue({
      ...
      data: {
        ...
        bankruptcy_requests: [],
        late_join_requests: [],
        boards: [], spaces: [], board_links: [], guardians: [], pending_junction: null, parking_pot: 0, jail: [], my_jail: null, card_decks: [], last_card_draw: null, held_cards: [], my_held_cards: [], pending_card: null, pending_payment: null,
