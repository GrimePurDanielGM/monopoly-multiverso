...
function snap(balance: number, version: number): ActiveSnapshot {
  return {
    ...
    runtime_status: 'running', current_landing_rent_resolved: false, building_stock: { houses_available: 32, hotels_available: 12 }, control: { paused_by_ref: null, finished_by_ref: null, reason: null },
