-- Fase 5 (corrección) — Snapshot: añade last_global_event (cobro del bote del Parking → banner para
-- todos). Reproduce 0041 y solo amplía el return. Saneado (sin ids internos), saldos privados.
