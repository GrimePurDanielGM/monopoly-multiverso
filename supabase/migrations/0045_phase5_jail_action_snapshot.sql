-- Fase 5 (corrección) — Snapshot: my_jail.action_taken_this_turn (si ya se ejecutó la acción de cárcel
-- de este turno). Reproduce 0043 y solo amplía my_jail. Saneado (sin ids internos), saldos privados.
