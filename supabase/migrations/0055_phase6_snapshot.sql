-- Fase 6 — Snapshot: añade por propiedad houses/has_hotel/mortgaged/monopoly/rent_due y, a nivel de
-- partida, building_stock (casas/hoteles disponibles). Reproduce 0051. Saneado (sin ids internos), saldos privados.
