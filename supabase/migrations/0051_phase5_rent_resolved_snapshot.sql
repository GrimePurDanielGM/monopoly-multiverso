-- Fase 5 (corrección) — Snapshot: expone current_landing_rent_resolved (la caída actual ya pagó alquiler).
-- Reproduce 0048 y solo añade ese campo. Saneado (sin ids internos), saldos privados.
