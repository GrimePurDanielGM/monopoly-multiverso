-- Fase 4 (pulido) — Snapshot: añade a cada propiedad los campos de la TARJETA de título (alquileres
-- con casas/hotel, coste de casa/hotel, hipoteca y deshipoteca) para la ficha completa de consulta.
-- Reproduce 0036 (pending_junction + guardians) y solo amplía el bloque v_props. Saneado (sin ids).
