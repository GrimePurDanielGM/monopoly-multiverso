-- Fase 5 (corrección ampliada) — Snapshot: expone config.dice_mode (dados físicos/virtuales). Reproduce
-- 0045 y solo amplía la config. Saneado (sin ids internos), saldos privados.
