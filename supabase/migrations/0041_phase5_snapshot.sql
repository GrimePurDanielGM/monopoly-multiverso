-- Fase 5 — Snapshot: expone casillas especiales (bote de Parking, estado de cárcel, mazos de cartas,
-- última carta robada, inventario de cartas conservables, carta/pago pendientes). Reproduce 0038 y
-- amplía el return. Saneado (sin ids internos), saldos privados, inventario completo solo del propio jugador.
